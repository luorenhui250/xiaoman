...
import com.numberousfor.xiaoman.bo.Book;
import com.numberousfor.xiaoman.bo.BookInfo;
import com.numberousfor.xiaoman.bo.BookList;
import com.numberousfor.xiaoman.service.Doc2Bean;
...
public class HttpUtils {
    ...
    public static HttpResponse doGet(String host, String path, Map<String, String> headers, Map<String, String> querys) throws Exception {
        HttpClient httpClient = warpClient(host, path);
     ...
     * @return
     */
    private static HttpClient warpClient(String host, String path) {
     ...
     * @throws Exception
     */
    public static JSONObject getJson(HttpResponse httpResponse) throws Exception {
    ...
    public static Document doGetReptile(String host, String path) throws Exception {
        HttpClient httpClient = warpClient(host, path);
        ...
        String text = EntityUtils.toString(httpClient.execute(request).getEntity(), "UTF-8");
